...
<body <?php body_class(); ?>>
    ...
    <header class="header-fixed">
            ...
            <div class="row flex-nowrap justify-content-between align-items-center">
				...
				if ( false === is_front_page() ) :
                    ...
                    <a href="/" title="<?= get_bloginfo( 'name' ); ?>">
                        <img class="header__logo" src="<?= get_template_directory_uri() ?>/assets/img/logo.svg" alt="Logo">
                    </a>
                    <?php
				else:
					?>
                ...
                <div class="header-widgets">
                    ...
                    <a href="/profile" class="btn btn-user user-profile">
                        <img class="avatar" src="<?= get_template_directory_uri() ?>/assets/img/user.jpg" alt="user profile image">
                        Профиль
                    </a>
                    <? endif; ?>
		...
		?>
            ...
            <? if ( ! is_user_logged_in() ): ?>
            <a href="/login" class="btn user-auth" title="Авторизация">
                Авторизация
            </a>
            <? else: ?>
