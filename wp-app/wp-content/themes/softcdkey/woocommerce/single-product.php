            ...
            <div class="product__header row">
                ...
                <div class="row mt-4">
                    ...
                    <div class="product__bundle">
                        ...
                        <button class="product__bundle--item <?php if ( $k === 0 ): echo 'is-active'; endif; ?>" data-product_id="<?= $item->get_product_id(); ?>">
                    ...
                    <div class="product__slider_content">
                        <div class="product__slider--main swiper">
                            <div class="swiper-wrapper">
                                <?php foreach ( $productGallery as $slideId ): ?>
                                <div class="swiper-slide">
                                    <a data-fancybox href="<?= wp_get_attachment_image_url( $slideId, 'full' ); ?>">
                        ...
                        <div class="product__content--2">
                            ...
                            <div class="product__cart">
                                ...
                                <div class="product__add-to-cart">
                                    ...
                                    <button class="product__add-to-cart--btn single-add_to_cart" data-product_id="<?= $product->get_id(); ?>" data-quantity="1" title="Добавить в корзину">
                                        <span>В корзину</span>
                                    </button>
                                </div>
                                <a class="product__quick-purchase" href="<?= get_quick_purchase_url( $product ); ?>" title="Купить в 1 клик">
                                    Купить в 1 клик
                                </a>
                            </div>
                        </div>
                ...
                <div class="row flex-nowrap">
                    ...
                    <div class="product__assets">
                        ...
                        <?php
									...
									?>
                        <a href="<?= get_post_meta( get_the_ID(), 'distributor_link', true ); ?>" download="distribution.exe" title="Скачать програму" rel="nofollow">
                            <i class="icon icon-download"></i>
                            Скачать програму
                        </a>
                        <?php
        ...
        <div class="product-desc__tabs">
            <div class="container">
                <div class="row product-desc__row">
                    ...
                    <button class="product-desc__tab mobile-tab" data-id="characteristics" title="Характеристики">
                        Характеристики
                    </button>
                    ...
                    <button class="product-desc__tab testimonials-disable" data-id="reviews" title="Отзывы">
                        Отзывы
                    </button>
                    <?php
						if ( ! empty( $faq ) ):
