...
<div class="product-card">
    ...
    <div class="product-card__bottom">
        <div class="product-card__cart">
            <a class="product-card__cart-laptop btn btn-outlined add-to-cart add_to_cart_button ajax_add_to_cart" href="<?= $product->add_to_cart_url(); ?>" value="<?= esc_attr( $product->get_id() ); ?>" data-product_id="<?= $product->get_id(); ?>" data-product_sku="<?= esc_attr( $product->get_sku() ); ?>" title="Добавить в Корзину" rel="nofollow">
                <span>Купить</span>
            </a>
            <a href="<?= get_quick_purchase_url( $product ); ?>" class="quick-purchase" title="Быстрая покупка" rel="nofollow">
                Быстрая покупка
            </a>
            <a class="product-card__cart-mobile btn btn-outlined add-to-cart add_to_cart_button ajax_add_to_cart" href="<?= $product->add_to_cart_url(); ?>" value="<?= esc_attr( $product->get_id() ); ?>" data-product_id="<?= $product->get_id(); ?>" title="Добавить в Корзину" rel="nofollow"></a>
            <div class="product-card__cart_tap">
                <a class="product-card__cart_tap-1 add_to_cart_button ajax_add_to_cart" href="<?= $product->add_to_cart_url(); ?>" value="<?= esc_attr( $product->get_id() ); ?>" data-product_id="<?= $product->get_id(); ?>" rel="nofollow">В Корзину</a>
